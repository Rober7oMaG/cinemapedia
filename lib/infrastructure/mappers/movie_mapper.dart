...
import 'package:cinemapedia/infrastructure/entities/movie_tmdb.dart';
...
class MovieMapper {
  static Movie theMovieDbToEntity(MovieTheMovieDB theMovieDB) => Movie(
    ...
    backdropPath: (theMovieDB.backdropPath != '')
      ? 'httpd://image.tmdb.org/t/p/w500${theMovieDB.backdropPath}'
    ...
    posterPath: (theMovieDB.posterPath != '')
      ? 'httpd://image.tmdb.org/t/p/w500${theMovieDB.posterPath}'
      : 'no-poster',
